...
static winid_t mainwin1 = 0;
static winid_t mainwin2 = 0;
...
void glk_main(void)
{
    ...
    glk_put_string("Note that the upper left-hand window accepts character input.");
    glk_put_string(" Hit 'h' to split the window horizontally, 'v' to split the");
    glk_put_string(" window vertically, 'c' to close a window,");
    glk_put_string(" and any other key (including special keys) to display key");
    glk_put_string(" codes. All new windows accept these same keys as well.\n\n");
